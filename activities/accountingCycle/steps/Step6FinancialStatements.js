...
// --- SERVICE INCOME STATEMENTS (RESTORED) ---
...
const ServiceSingleStepIS = ({ data, onChange, isReadOnly, showFeedback, calculatedTotals }) => {
    ...
    // RESTORED: Blue button style from previous version
    const btnStyle = "ml-4 mb-2 text-xs text-white bg-blue-700 px-2 py-1 rounded flex items-center gap-1 hover:bg-blue-800";
        ...
        <div className="border rounded bg-white flex flex-col h-full shadow-sm">
            ...
            <div className="p-4 overflow-y-auto flex-1 text-xs">
                <div className="mb-4">
                    ...
                    <div className="flex justify-between items-center py-1 font-bold mt-1 border-t border-black"><span className="pl-0">Total Revenues</span><input type="text" className=${inputClass(showFeedback && !checkField(data?.totalRevenues, expRev))} value=${data?.totalRevenues || ''} onChange=${(e)=>updateData({ totalRevenues: e.target.value })} disabled=${isReadOnly}/></div>
                </div>
                <div className="mb-4">
                    ...
                    <div className="flex justify-between items-center py-1 font-bold mt-1 border-t border-black"><span className="pl-0">Total Expenses</span><input type="text" className=${inputClass(showFeedback && !checkField(data?.totalExpenses, expExp))} value=${data?.totalExpenses || ''} onChange=${(e)=>updateData({ totalExpenses: e.target.value })} disabled=${isReadOnly}/></div>
                </div>
                <div className="space-y-1 mt-4 border-t-2 border-black pt-2">
...
const MerchPeriodicIS = ({ data, onChange, isReadOnly, showFeedback, calculatedTotals, type = "Single" }) => {
    ...
    const btnStyle = "ml-4 mb-1 text-xs text-white bg-blue-700 px-2 py-1 rounded flex items-center gap-1 hover:bg-blue-800 cursor-pointer";
